...
public class FhirServerConfigCommon {
  ...
  public IBinaryStorageSvc binaryStorageSvc(AppProperties appProperties) {
    ...
    String binaryStorageDirectory = appProperties.getBinary_storage_filesystem_directory();
    IBinaryStorageSvc binaryStorageSvc;
    if (null == binaryStorageDirectory || binaryStorageDirectory.equals("")) {
      binaryStorageSvc = new DatabaseBlobBinaryStorageSvcImpl();
    } else {
      binaryStorageSvc = new FilesystemBinaryStorageSvcImpl(binaryStorageDirectory);
    }
